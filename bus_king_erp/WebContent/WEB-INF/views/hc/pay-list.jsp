		...
		<table border="1">
			...
			<c:forEach items="${paylist}" var="list">
				<tr>
					<td>${list.pay_code}</td>
					<td>${list.pay_e_no}</td>
					<td>${list.pay_e_name}</td>		<!-- fk로 참조하는 데이터 필드의 변수명은... DTO 와 동일해야함... -->
					...
					<td><fmt:parseDate value='${list.pay_day}' var='pay_day' pattern='yyyy-mm-dd'/>
                  	<fmt:formatDate value="${pay_day}" pattern="yyyy.mm.dd"/></td> 
                  	<td></td>
                  	<td></td>
