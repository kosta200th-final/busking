...
<h1 style="text-align: center;">차량 점검 등록</h1>
	<div align="center">
			<input type="text" name="re_code" id="re_code" placeholder="re_code" hidden="" ><br><br>
			<select name="re_b_no">
			<c:forEach items="${repairlist}" var="repairlist">
		    <option value="${repairlist.re_b_no}">버스번호</option>
		    </c:forEach>
			</select>
			버스 번호 :<input type="text" name="re_b_no" id="re_b_no" placeholder="버스번호" value="${repairlist.re_b_no}"><br><br>
			...
			<label for = "re_breakdown">정비 내역 : </label>
			<input type = "radio" name = "re_breakdown" value = "차량사고">차량사고
        	<input type = "radio" name = "re_breakdown" value = "차량노후">차량노후<br><br>
		    <label for = "re_state">정비상태 : </label>
			<input type = "radio" name = "re_state" value = "정비접수">접수
			<input type = "radio" name = "re_state" value = "정비중">수리중<br><br>
        	<input type = "radio" name = "re_state" value = "정비완료">수리완료<br><br>
